...
# Generated on 2025-07-27 11:19:58
...
def load_best_model():
    ...
    model = joblib.load('models/ridge_regression_optimized_20250727_111958.pkl')
    scaler = joblib.load('models/robust_scaler_20250727_111958.pkl')
    
    with open('models/model_metadata_20250727_111958.pkl', 'rb') as f:
